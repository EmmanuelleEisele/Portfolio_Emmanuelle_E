        ...
        <div className="bg-gray-900 rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="space-y-8 leading-relaxed">
            ...
            <p className="mb-4">
              ...
              utilisateurs et visiteurs du site : www.emmanuelle-eisele.com les
            ...
            <section>
              ...
              <p className="mt-4">
                ...
                autorisation expresse d'Emmanuelle Eiselé.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Ce site portfolio ne collecte aucune donnée personnelle. Aucun
                formulaire de contact, aucun cookie, aucun système de tracking
                n'est utilisé sur ce site.
              </p>
              <p className="mt-4">
                Si vous souhaitez me contacter, utilisez l'adresse email
                mentionnée ci-dessus. Vos communications par email restent
                privées et ne sont partagées avec aucun tiers.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">
                Emmanuelle Eiselé ne pourra en aucun cas être tenue responsable
                de tout dommage de quelque nature qu'il soit résultant de
            ...
            <section>
              ...
              <p>
                Ce site peut contenir des liens vers d'autres sites (GitHub,
                projets en ligne, etc.). Emmanuelle Eiselé ne saurait être
                responsable du contenu de ces sites externes ni des dommages qui
            ...
            <section className="bg-gray-50 p-6 rounded-lg text-gray-900">
              ...
              <Link
                ...
                className="mt-2 font-semibold hover:text-blue-500"
              >
                <strong>Email :</strong> emmanuelle.eisele@outlook.com
              </Link>
            </section>
